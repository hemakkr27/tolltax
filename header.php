...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Toll Tax Management System</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
						...
						<!--	   <a class="nav-link" href="#">Recipients</a>
                            ...
                            <a class="nav-link" href="#">Pass History </a>
                            <a class="nav-link" href="#">Daily Pass Report</a>
                            <a class="nav-link" href="#">Daily Pass History Report</a>
                            <a class="nav-link" href="#">Daily Recipient Report</a>
                            <a class="nav-link" href="#">list of Categories</a>
                            <a class="nav-link" href="#">list of Toll Gates</a>
