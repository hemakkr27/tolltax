...
<html lang="en">
    <head>
        ...
        <title>Login | Toll Tax Management System</title>
        <link href="css/styles.css" rel="stylesheet" />
		  <style>
    body{
      background-image: url("http://localhost/ttms/uploads/cover.png?v=1651131093");
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <br />
                                <br />
                                <h3 class="text-center text-danger mt-5"><b>Toll Tax Management System</b></h3>
